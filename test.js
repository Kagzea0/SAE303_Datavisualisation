...
const invCanvas = document.getElementById('aaa');
...
fetch('JSON/Bazar/Investissements_SNCF_Mobilites.json')
...
const colCanvas = document.getElementById('bbb');
...
// Charger le fichier JSON
fetch('JSON/Bazar/Collisions_passages_à_niveau_depuis_2004.json')
    .then(response => response.json())
    .then(data => {
        // Mettre à jour les données du graphique
